...
<section class="container mt-5">
    <div class="card">
        ...
        {{-- filter --}}
        <div class="card-body">
            <form action="{{ route('report_sale.filter') }}" method="GET" id="filterForm">
                <div class="row">
                    <div class="col-md-3">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    @forelse ($data as $key => $report_sale)
                    <tr>
                        <td>{{ $key + 1 }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="11" class="text-center">Tidak ada laporan penjualan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <a href="{{ route('report_sale.exportExcel', request()->query()) }}" class="btn btn-secondary">
                <i class="fa-solid fa-file-excel"></i> Export Excel
            </a>
            <a href="{{ route('report_sale.exportPdf', request()->query()) }}" class="btn btn-secondary">
